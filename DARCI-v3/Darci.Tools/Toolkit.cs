...
public class Toolkit : IToolkit
{
    ...
    {
        var prompt = $@"Classify the intent of this message. Respond with ONLY one word from this list:
conversation, question, research, task, reminder, goalupdate, statuscheck, feedback
...
Intent:";
        ...
        var intentStr = response.Trim().ToLowerInvariant();
        ...
        var type = intentStr switch
        {
            ...
            _ => IntentType.Conversation // Default to conversation
        };
